...
const tools = [
  ...
  { type: 'function', name: 'calculate', description: 'Perform basic arithmetic. Only digits, decimal points, parentheses and + - * / % operators are allowed.', parameters: { type: 'object', properties: { expression: { type: 'string' } }, required: ['expression'] } },
  { type: 'function', name: 'save_memory', description: 'Save a user-provided preference or fact only when the user explicitly asks you to remember it.', parameters: { type: 'object', properties: { session_id: { type: 'string' }, memory: { type: 'string' } }, required: ['session_id', 'memory'] } },
  { type: 'function', name: 'recall_memory', description: 'Recall saved user memories for this local session.', parameters: { type: 'object', properties: { session_id: { type: 'string' } }, required: ['session_id'] } },
  { type: 'function', name: 'create_note', description: 'Create a local note for the user.', parameters: { type: 'object', properties: { session_id: { type: 'string' }, title: { type: 'string' }, body: { type: 'string' } }, required: ['session_id', 'title', 'body'] } },
  { type: 'function', name: 'list_notes', description: 'List recent local notes for this session.', parameters: { type: 'object', properties: { session_id: { type: 'string' } }, required: ['session_id'] } }
];
